...
namespace face_api_commons.Authentication
{
    ...
    {
        User_auth AuthenticateUser(string username, string password);
    }
    ...
    public class AuthenticationService: IAuthenticationService
    {
        ...
        public User_auth AuthenticateUser(string username, string clearTextPassword)
        {
            ...
            return new User_auth(userData.Username, userData.Email, userData.Roles);
        }
